...
class Financeiro extends Model
{
    ...
    public static function Conciliacao($cd_empresa, $dt_ini, $dt_fim)
    {
        ...
        cast(MC.DS_COMPLEMENTO as varchar(1000) character set utf8) DS_COMPLEMENTO,
    ...
    FROM MOVTOCAIXA MC
        LEFT JOIN MOVTOCAIXACTB CTB ON (CTB.CD_EMPRESA = MC.CD_EMPRESA
    ...
    ";
        return DB::connection(Auth::user()->conexao)->select($query);
    }
}
