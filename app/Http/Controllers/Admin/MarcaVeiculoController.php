...
class MarcaVeiculoController extends Controller
{
    ...
    public function delete(Request $request)
    {
        ...
        if($this->marcamodelo->verifyIfExistsMarca($request->cd_marca)){
            return redirect()->route('marca-veiculo')->with('warning', 'Essa marca está associada com modelo, não e possivel excluir!');
