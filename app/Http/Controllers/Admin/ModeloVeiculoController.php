...
class ModeloVeiculoController extends Controller
{
  ...
  public function delete(Request $request)
  {
    ...
    if ($this->marcamodelo->verifyIfExistsModelo($request->cd_modelo)) {
      return redirect()->route('modelo-veiculo')->with('warning', 'Esse modelo está associada com uma marca, não é possivel excluir!');
    }
