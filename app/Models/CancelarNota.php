...
class CancelarNota extends Model
{
    ...
    public function list($cd_requerente){
        return CancelarNota::select('cancelar_notas.cd_empresa', 'cancelar_notas.nr_nota', 'cancelar_notas.nr_cnpjcpf', 
        'cancelar_notas.nm_pessoa', 'cancelar_notas.motivo', 'cancelar_notas.created_at')
