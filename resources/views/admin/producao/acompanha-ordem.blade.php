                ...
                <form class="form-inline" action="{{route('admin.producao.acompanha.ordem')}}" method="post">
                    ...
                    <div class="box-body">
                        <div class="form-group m-2">
                            ...
                            (<a
                                href="http://zxing.appspot.com/scan?ret=https://producao.ivorecap.com.br/producao/acompanha-ordem/{CODE}" data-toggle="tooltip" data-placement="top" title="Exclusivo Celular">Leitor</a>):
