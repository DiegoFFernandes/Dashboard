<aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="tab-content">
        <div id="control-sidebar-theme-demo-options-tab" class="tab-pane active">
            <div>
                <h4 class="control-sidebar-heading">Opções de Layout</h4>                
                <div class="form-group">
                    <label class="control-sidebar-subheading">
                        <input id="control-sidebar-collapsed" type="checkbox" data-enable="expandOnHover" class="pull-right">Menu Lateral
                    </label>
                    <p>Mantem o menu lateral aberto</p>
                </div>
