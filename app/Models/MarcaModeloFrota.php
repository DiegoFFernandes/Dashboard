...
class MarcaModeloFrota extends Model
{
    ...
    public function MarcaModeloAll(){
        return MarcaModeloFrota::select('marca_modelo_frotas.id', 'marca_modelo_frotas.cd_marca', 
        'marcaveiculos.descricao as dsmarca','marca_modelo_frotas.cd_modelo','modeloveiculos.descricao as dsmodelo', 
        'marca_modelo_frotas.cd_frota', 'frotaveiculos.descricao as dsfrota','marca_modelo_frotas.cd_usuario', 
