...
Route::middleware(['auth', 'role:admin'])->prefix('powerbi')->group(function () {
    Route::get('atualizar-tabelas-power-bi', [PowerBiEmbeddedController::class, 'updateTablesPowerBi'])->name('tables-powerbi.update');
});
