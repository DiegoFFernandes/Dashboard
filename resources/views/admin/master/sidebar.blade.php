    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ request()->segment(1) == 'financeiro' ? 'active' : '' }}" style="height: auto;">
                ...
                <ul class="treeview-menu" style="display: none;">
                    <li class="{{ request()->routeIs('adiantamento-despesas.index') ? 'active' : '' }}"><a
                            href="{{ route('adiantamento-despesas.index') }}"><i class="fa fa-thumbs-up"></i>Adiantamento Despesas</a>
                    </li>
                    @role('admin|financeiro')
                        ...
                        <li class="{{ request()->routeIs('libera-contas.index') ? 'active' : '' }}"><a
                                href="{{ route('libera-contas.index') }}"><i class="fa fa-thumbs-up"></i>Liberação
                                Contas
                                a Pagar</a>
                        </li>
                    @endrole
                ...
                <li class="treeview {{ request()->segment(1) == 'compras' ? 'active' : '' }}" style="height: auto;">
                    ...
                    <ul class="treeview-menu" style="display: none;">
                        <li class="{{ request()->routeIs('libera-pedido-compra.index') ? 'active' : '' }}"><a
                                href="{{ route('libera-pedido-compra.index') }}"><i class="fa fa-thumbs-up"></i>Liberação
                                de Compra</a>
                        </li>
                </li>
            </ul>
