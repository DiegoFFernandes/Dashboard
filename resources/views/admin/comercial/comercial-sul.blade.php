...
@section('scripts')
    <script type="text/javascript" defer>
        if ($(window).width() < 960) {
            let div = '<div class="iframe-embed-wrapper iframe-embed-responsive-16by9">' +
                '<iframe src="https://app.powerbi.com/view?r=eyJrIjoiNjhhODJkM2UtZDZmZi00NzdmLWIyOTYtZjU3MzRmNjAxYWY3IiwidCI6ImUwZTY3NmNhLTU0YTYtNDlhZC1hNzgyLWJmYmNjYTk5ZWViMyJ9" frameborder="0">' +
                '</iframe>' +
                '</div>';
    ...
    <script src="{{ asset('js/comercial-sul/script.js?v=2') }}"></script>
@endsection
